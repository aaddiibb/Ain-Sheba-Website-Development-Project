...
@section('title', 'Add Assessment — Ain Sheba')
...
<h4 class="fw-bold mb-4">Add Assessment</h4>
...
<form method="POST" action="{{ route('lawyer.assessment.store', $module->id) }}">
    @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="time_limit_minutes"
                       ...
                       min="1" value="{{ old('time_limit_minutes') }}"
    ...
    <div class="card border-0 shadow-sm p-4 mb-4">
        ...
        <div id="questions-list">
            <p class="text-muted small text-center py-3" id="questions-empty-hint">
