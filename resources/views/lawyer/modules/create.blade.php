...
@section('title', 'Add Module — Ain Sheba')
...
<h4 class="fw-bold mb-4">Add Module</h4>

<div class="card border-0 shadow-sm p-4">
    <form method="POST" action="{{ route('lawyer.modules.store', $program->id) }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            <textarea name="content" rows="8"
                      ...
                      placeholder="Explain the law or right in plain language. Be thorough — this is what citizens will read.">{{ old('content') }}</textarea>
            @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="duration_minutes" min="0"
                   ...
                   value="{{ old('duration_minutes', 0) }}" required style="max-width:180px">
